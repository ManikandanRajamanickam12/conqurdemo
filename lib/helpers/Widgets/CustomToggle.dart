...
class CustomNeumorphicToggleStyle {
  final double? depth;
  ...
  const CustomNeumorphicToggleStyle({
    this.depth,
  ...
  bool operator ==(Object other) =>
      ...
      other is CustomNeumorphicToggleStyle &&
...
/// Direct child of CustomNeumorphicToggle
...
///
/// Switch with custom thumb (defined with list of CustomToggleElements)
///
...
///),
@immutable
class CustomNeumorphicToggle extends StatelessWidget {
  static const MIN_EMBOSS_DEPTH = -1.0;

  final EdgeInsets padding;

  final List<CustomToggleElement> children;
  final Widget thumb;
  ...
  final CustomNeumorphicToggleStyle? style;
  final double height;
  final double? width;
  ...
  const CustomNeumorphicToggle({
    this.style = const CustomNeumorphicToggleStyle(),
    Key? key,
