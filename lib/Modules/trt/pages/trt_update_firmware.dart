...
class TRTUpdateFirmware extends StatefulWidget {
  const TRTUpdateFirmware({Key? key}) : super(key: key);
  @override
  State<TRTUpdateFirmware> createState() => _TRTUpdateFirmwareState();
}

class _TRTUpdateFirmwareState extends State<TRTUpdateFirmware> {
        ...
        child: Column(
          children: [
            ...
            if (deviceData.connectionStatus == true)
              GestureDetector(
                onTap: (() {
                  TRTBloc.instance.add(TRTHelpEvent());
                }),
                child: Text(
                  "Connected",
