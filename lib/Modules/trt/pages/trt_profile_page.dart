...
class TRTProfilePage extends StatefulWidget {
  const TRTProfilePage({Key? key}) : super(key: key);

  @override
  State<TRTProfilePage> createState() => _TRTProfilePageState();
}

class _TRTProfilePageState extends State<TRTProfilePage> {
  bool edit = false;
  File? image;
                  ...
                  child: NeumorphicButton(
                    ...
                    onPressed: () {
                      setState(() {
                        ...
                        TRTBloc.instance.add(TRTUpdateFirmwareEvent());
                      });
                    },
                    child: Container(
                      width: 100,
