...
import 'package:conqur/Modules/dashboard/pages/sync_ongoing_page.dart';
import 'package:conqur/Modules/dashboard/pages/sync_training_page.dart';
    ...
    return Scaffold(
      ...
      body: BlocBuilder<DashboardBloc, DashboardState>(
        ...
        builder: (context, state) {
          ...
          } else if (state is DashboardStopTrainingState) {
            return SyncTrainingPage();
          } else if (state is DashboardSyncTrainingState) {
            return SyncOngoingPage();
          } else {
            return HomePage(
              state: HomePageState.sensorDisconnected,
            );
