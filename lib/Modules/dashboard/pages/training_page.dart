...
class TrainingHeaderView extends StatefulWidget {
  const TrainingHeaderView({
    Key? key,
  }) : super(key: key);

  @override
  State<TrainingHeaderView> createState() => _TrainingHeaderViewState();
}

class _TrainingHeaderViewState extends State<TrainingHeaderView> {
                  ...
                  TextButton.icon(
                      onPressed: () {
                        DashboardBloc.instance
                            .add(DashboardStopTrainingEvent(msg: ""));
                      },
                      icon: Icon(
                        Icons.stop,
                        color: Colors.black,
