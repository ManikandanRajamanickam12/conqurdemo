...
class DashboardStopTrainingEvent extends DashboardEvent {
  final String msg;
  const DashboardStopTrainingEvent({required this.msg});

  @override
  List<Object?> get props => [msg];
}

class DashboardSyncTrainingEvent extends DashboardEvent {
  final String msg;
  const DashboardSyncTrainingEvent({required this.msg});

  @override
  List<Object?> get props => [msg];
}

class DashboardGetSyncReadProgressEvent extends DashboardEvent {
  final String msg;
  const DashboardGetSyncReadProgressEvent({required this.msg});
